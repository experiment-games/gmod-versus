...
#       We run this as the steam user, which is part of the `www-data` group (for /srv/versus) and has read access to the error files.
#
# 4.    Make sure to set up the Discord webhook config file at `/srv/versus/tools/.env`
