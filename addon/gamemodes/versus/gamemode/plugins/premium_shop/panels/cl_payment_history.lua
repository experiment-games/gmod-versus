...
do
  ...
  function PANEL:SetPaymentRecord(record, index)
    ...
    self.orderLabel:SetFont("VersusDefault")
    ...
    if (canClaim) then
      -- Show claim button
      self.claimButton = buttonRow:Add("versus_Button")
    ...
    elseif (hasPackage) then
      ...
      ownedLabel:SetFont("VersusSmall")
    ...
    elseif (record.status == "expired" or record.status == "refunded" or record.status == "canceled") then
      ...
      statusInfo:SetFont("VersusSmall")
  ...
  vgui.Register("versus_PaymentRecordPanel", PANEL, "EditablePanel")
end
...
do
  ...
  function PANEL:DisplayPaymentRecords(paymentRecords)
    ...
    for i, record in ipairs(paymentRecords) do
      local recordPanel = self.scroll:Add("versus_PaymentRecordPanel")
  ...
  vgui.Register("versus_PaymentHistoryPanel", PANEL, "DFrame")
end
