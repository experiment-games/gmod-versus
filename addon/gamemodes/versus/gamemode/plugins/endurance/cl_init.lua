...
net.Receive("versus.endurance.matchmakingResult", function()
  ...
  if success then
    ...
    chat.AddText(Color(120, 200, 120), "[Endurance] ", Color(220, 230, 240), "Match found! Connecting to " .. message .. "…")
  else
...
concommand.Add("versus_endurance_matchmaking", function()
  if not GetGlobalBool("VersusHideoutMap", false) then
    chat.AddText(Color(220, 80, 80), "[Endurance] ", Color(220, 230, 240), "You can only queue for Endurance from the hideout.")
    return
  end
