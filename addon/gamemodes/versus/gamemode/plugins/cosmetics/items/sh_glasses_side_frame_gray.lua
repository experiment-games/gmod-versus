...
function ITEM:getPacData(player, entity)
  ...
  local genderOffset = entity:GetModel():find("female") and -0.5 or 0
  local position = Vector(-2.2122497558594 + genderOffset, 0, -2.09669342041)
      ...
      ["children"] = {
        [1] = {
          ...
          ["self"] = {
            ...
            ["ModelModifiers"] = "",
            ["EyeTargetUID"] = "",
            ["Model"] = "models/plet/huge_glasses_pack/mgsv_hideo_white_glasses.mdl",
          },
        },
      },
      ["self"] = {
