...
ITEM.cost = 2000
ITEM.equipSlot = "face"
ITEM.model = "models/plet/huge_glasses_pack/codiw_hero_scientist_glasses.mdl"
ITEM.description = "A pair of glasses that look like they belong to a scientist."
...
function ITEM:getPacData(player, entity)
  ...
  local position = Vector(-2.7122497558594, 0, -1.219669342041)
      ...
      ["children"] = {
        [1] = {
          ...
          ["self"] = {
            ...
            ["ModelModifiers"] = "",
            ["EyeTargetUID"] = "",
            ["Model"] = "models/plet/huge_glasses_pack/codiw_hero_scientist_glasses.mdl",
          },
        },
      },
      ["self"] = {
