...
SWEP.Description =
"The FAMAS G2 is a French bullpup assault rifle known for its distinctive design and high rate of fire. Chambered in 5.56x45mm NATO, it is widely used by military and law enforcement agencies."
SWEP.Weight = 4
...
SWEP.Attachments                = {
  [1] = { header = "Sight", offset = { 850, -600 }, atts = { "md_microt1", "md_eotech", "md_aimpoint", "md_schmidt_shortdot", "md_acog" } },
...
SWEP.Sounds                     = {
  draw = { { time = 0, sound = "CW_FAMASG2_CLOTH" } },

  reload = {
    [1] = { time = 0.65, sound = "CW_FAMASG2_MAGOUT" },
