...
SWEP.PrintName = "MR96"
SWEP.Description =
"German double-action revolver chambered in .44 Magnum. The MR96 is known for its robust construction and powerful cartridge, making it a favored choice for both law enforcement and civilian use."
SWEP.Weight = 2
...
SWEP.Attachments         = {
  [1] = { header = "Barrel", offset = { -250, -75 }, atts = { "bg_regularbarrel", "bg_longbarrelmr96" } },
...
SWEP.Sounds              = {
  draw = { { time = 0, sound = "CW_FOLEY_LIGHT" } },

  reload = {
    [1] = { time = 0.2, sound = "CW_MR96_CYLINDEROPEN" },
