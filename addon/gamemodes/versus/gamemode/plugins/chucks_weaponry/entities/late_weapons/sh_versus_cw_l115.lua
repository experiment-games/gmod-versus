...
SWEP.PrintName = "L115"
SWEP.Description =
"The L115 is a British bolt-action sniper rifle chambered in .338 Lapua Magnum. Renowned for its long-range accuracy and stopping power, it is a preferred choice for military snipers."
SWEP.Weight = 5
...
SWEP.Sounds                   = {
  shot = { { time = 0.5, sound = "CW_L96_BOLTUP" },
