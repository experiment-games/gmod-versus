...
SWEP.Description =
"The Desert Eagle is a semi-automatic pistol known for its large caliber and distinctive design. Chambered in .50 AE, it delivers significant stopping power."
SWEP.Weight = 3
...
SWEP.Attachments         = {
  [1] = { header = "Sight", offset = { 450, -350 }, atts = { "md_microt1", "md_eotech", "md_acog" } },
...
SWEP.Sounds              = {
  ...
  reload = {
    [1] = { time = 0.42, sound = "CW_DEAGLE_MAGOUT" },
