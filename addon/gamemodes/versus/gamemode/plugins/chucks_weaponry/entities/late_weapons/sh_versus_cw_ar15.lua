...
SWEP.Description =
"Lightweight and versatile assault rifle chambered in 5.56x45mm NATO. The AR-15 is known for its modularity and ease of customization."
SWEP.Weight = 3
...
SWEP.Attachments            = {
  [1] = { header = "Sight", offset = { 950, -600 }, atts = { "bg_foldsight", "md_microt1", "md_eotech", "md_aimpoint", "md_schmidt_shortdot", "md_acog", "md_nightforce_nxs" } },
...
SWEP.Sounds                 = {
  ...
  reload = {
    [1] = { time = 0.35, sound = "CW_AR15_MAGOUT" },
