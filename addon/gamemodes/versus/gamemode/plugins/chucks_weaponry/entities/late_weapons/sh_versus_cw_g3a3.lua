...
SWEP.PrintName = "G3A3"
SWEP.Description =
"The G3A3 is a German battle rifle chambered in 7.62x51mm NATO. Known for its reliability and robust design, it has been widely used by military forces around the world."
SWEP.Weight = 4
...
SWEP.Attachments         = {
  [1] = { header = "Sight", offset = { 800, -350 }, atts = { "md_microt1", "md_eotech", "md_aimpoint", "md_schmidt_shortdot", "md_acog", "bg_sg1scope", "md_nightforce_nxs" } },
...
SWEP.Sounds              = {
  ...
  reload_full = {
    [1] = { time = 0.6, sound = "CW_G3A3_HANDLE" },
    [2] = { time = 0.9, sound = "CW_G3A3_MAGOUT" },
    [3] = { time = 2.3, sound = "CW_G3A3_MAGIN" }
  },

  reload = {
    [1] = { time = 0.6, sound = "CW_G3A3_BOLTBACK" },
