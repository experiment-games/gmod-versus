...
SWEP.Description =
"German submachine gun chambered in 9x19mm Parabellum. The HK MP5 is renowned for its reliability, compact design, and widespread use among military and law enforcement agencies."
SWEP.Weight = 3
...
SWEP.Sounds              = {
  ...
  reloadfull = {
    [1] = { time = 1.1, sound = "CW_MP5_MAGOUT" },
    [2] = { time = 1.4, sound = "CW_MP5_MAGIN" }
  },

  reloadempty = {
    [1] = { time = 0.4, sound = "CW_MP5_BOLTBACK" },
