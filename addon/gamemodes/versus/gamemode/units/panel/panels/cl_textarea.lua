...
function PANEL:Init()
  ...
  self.textEntry:SetTabbingDisabled(true)
...
function PANEL:Paint(w, h)
  local currentBg = self.textEntry:HasFocus() and self.focusColor or self.bgColor
...
function PANEL:PerformLayout(w, h)
  self.textEntry:SetPos(8, 6)
  self.textEntry:SetSize(w - 16, h - 12)
end

vgui.Register("versus_TextArea", PANEL, "EditablePanel")
