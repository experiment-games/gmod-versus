...
Although 1024x1024 is ideal, Garry's Mod may refuse it. 1024x768 works fine; you'll just need to crop and resize the screenshot later.
...
- `cl_leveloverviewmarker 768` draws a 768x768 square showing the screenshot area
...
3. If you used 1024x768, crop the image to a square (768x768) where the top-left corner stays in the same place.
...
1. Make sure you used windowed mode (`mat_setvideomode 1024 768 1`)
